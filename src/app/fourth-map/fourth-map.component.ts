...
@Component({
  selector: 'app-fourth-map',
  templateUrl: './fourth-map.component.html',
  styleUrls: ['./fourth-map.component.scss']
})
export class FourthMapComponent {
  title = 'mapExample';
  map: any;
  lblLocation: any;
        ...
        dialogRef.afterClosed().subscribe((result: any) =>{
          if(result){
            if (result.value.placeType === 'h') {
              ...
              // .on('dragend', (e: L.LeafletEvent) => { editMarkerDetail(e, locationList.length - 1) })
